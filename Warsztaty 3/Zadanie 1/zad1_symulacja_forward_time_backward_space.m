...
u_1 = forward_time_backward_space(lambda,h_1,false,0);
u_2 = forward_time_backward_space(lambda,h_2,false,0);
u_3 = forward_time_backward_space(lambda,h_3,false,0);
u_4 = forward_time_backward_space(lambda,h_4,false,0);
...
for i = 1:n_init_4
    pause(0.05)        % Można modyfikować, żeby zmienić szybkość animacji
