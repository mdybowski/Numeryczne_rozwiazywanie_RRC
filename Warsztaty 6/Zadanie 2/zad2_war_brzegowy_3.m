...
u_1 = zad2_rownanie_falowe_3(x_p, x_k, t_k, a, h_1, lambda,false,0);
u_2 = zad2_rownanie_falowe_3(x_p, x_k, t_k, a, h_2, lambda,false,0);
u_3 = zad2_rownanie_falowe_3(x_p, x_k, t_k, a, h_3, lambda,false,0);
...
for i = 1:n_init_3
    ...
    if i <= n_init_1
    set(p1(1), 'XData', x_1, 'YData', cos(x_1+t_1(i)) + cos(x_1-t_1(i)));
    ...
    if i <= n_init_2
    set(p2(1), 'XData', x_2, 'YData', cos(x_2+t_2(i)) + cos(x_2-t_2(i)));
    set(p2(2), 'XData', x_2, 'YData', u_2(:, i));
    subplot(3,1,2)
    title(['t = ' num2str(t_2(i))]);
    end
    
    set(p3(1), 'XData', x_3, 'YData', cos(x_3+t_3(i)) + cos(x_3-t_3(i)));
...
u_1_dokladne = cos(x_1'+t_1) + cos(x_1'-t_1);
u_2_dokladne = cos(x_2'+t_2) + cos(x_2'-t_2);
u_3_dokladne = cos(x_3'+t_3) + cos(x_3'-t_3);
