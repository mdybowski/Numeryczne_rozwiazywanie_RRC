function u = crank_nicolson_zad2(x_p, x_k, t_k, b, mu,...
    f, u_0, h,rysuj,t_0)
% Parametry
k = mu*h*h;
...
% Warunek brzegowy 
x_brzeg_p = rozw_dokladne_zad2(x_p, t);
x_brzeg_k = rozw_dokladne_zad2(x_k, t);
u(1,:) = x_brzeg_p;
u(end,:) = x_brzeg_k;
...
for n = 2:n_init
    ...
    u(2:end-1,n) = algorytm_thomasa(a_thomas, b_thomas, c_thomas,...
        d_thomas, x_brzeg_p(n-1), x_brzeg_k(n-1))';
end
