...
u_1 = burgers_metoda_zachowawcza(uL_1,uR_1,lambda,h);
u_2 = burgers_metoda_zachowawcza(uL_1,uR_2,lambda,h);
u_3 = burgers_metoda_zachowawcza(uL_2,uR_1,lambda,h);
u_4 = burgers_metoda_zachowawcza(uL_2,uR_2,lambda,h);
...
% Metoda ta daje lepsze rozwiazanie niz metoda forward-time backward-space.
% Jej bledem jest to ze "generalnie" zgadza sie ze slabym rozwiazaniem
% ale w miejscu gdzie jest "skok" wraz z uplywem czasu metoda nie przybliza
% sie coraz bardziej do rozwiazania slabego. 
